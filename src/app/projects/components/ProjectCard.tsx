...
const ProjectCard = (props: Project) => {
	...
	return (
		<MagicCard
			className="cursor-pointer rounded-lg dark:shadow-2xl w-[45%] max-sm:w-full h-[360px] border-none !bg-transparent"
		...
		>
			...
			>
				...
				<div
					className={`px-3 mt-3 !pointer-events-auto flex gap-1 ${props.techStack && props.techStack?.length > 0 ? "mt-3" : "mt-0"}`}
				>
					{props.link && (
